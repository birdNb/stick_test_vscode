...
#define LCD_CS_Clr()  {HAL_GPIO_WritePin(LCD_CS_GPIO_Port, LCD_BLK_Pin, GPIO_PIN_RESET);}
#define LCD_CS_Set()  {HAL_GPIO_WritePin(LCD_CS_GPIO_Port, LCD_BLK_Pin, GPIO_PIN_SET);}
